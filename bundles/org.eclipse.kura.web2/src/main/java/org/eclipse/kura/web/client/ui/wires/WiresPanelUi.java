...
public class WiresPanelUi extends Composite
    ...
    private void loadStaticInformation(GwtWireComposerStaticInfo staticInfo) {
        ...
        this.dialogs.setDriverFactoryPids(this.configurations.getDriverFactoryPidNames());
    ...
    private Map<String, String> getAssetsNotInComposer() {
        ...
        while (i.hasNext()) {
            ...
            if (this.wireComposer.getWireComponent(pidEntry.getKey()) != null) {
                i.remove();
            }
        }
        return assetPids;
