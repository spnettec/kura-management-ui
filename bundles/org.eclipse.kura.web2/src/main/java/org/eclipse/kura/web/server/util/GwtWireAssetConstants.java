...
public class GwtWireAssetConstants {
    ...
    public static final GwtConfigComponent WIRE_ASSET_CHANNEL_DESCRIPTOR = GwtServerUtil.toGwtConfigComponent(
            GwtServerUtil.toComponentConfiguration("", WireAssetChannelDescriptor.get().getDescriptor()),
            WireAssetChannelDescriptor.get().getDescriptor(), LocaleContextHolder.getLocale().getLanguage());
