...
public abstract class SnapshotSelectorModal extends Composite {
    ...
    private void updateSelectedPidsCounter() {
        ...
        StringBuilder counterTextBuilder = new StringBuilder(MSGS.snapshotDownloadSelectPids()).append(" ")
                .append(selectedPids).append("/").append(this.pidPanel.getWidgetCount());
